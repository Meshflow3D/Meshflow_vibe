...
pub use events::{
    ...
    RequestLoadBatchEvent, RequestLoadEvent, RequestReloadEvent, RequestSaveEvent,
    RuntimeDataReadyEvent, WorldLoadBatchSuccessEvent, WorldLoadSuccessEvent,
...
// Meshflow Vibe Core plugin
pub struct MeshflowVibeCore {
    pub logging: bool,
}
impl Plugin for MeshflowVibeCore {
