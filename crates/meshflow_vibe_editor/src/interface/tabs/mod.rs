...
pub use entity_editor::{
    handle_material_deletion_system, update_entity_editor_tab_system,
    update_entity_with_new_components_system, update_entity_with_new_identity_system,
    update_entity_with_new_transform_system, update_material_handle_system, EntityEditorTabData,
};
